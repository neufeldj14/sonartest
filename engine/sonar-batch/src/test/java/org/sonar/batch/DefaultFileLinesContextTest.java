...
public class DefaultFileLinesContextTest {
  ...
  public void shouldSave() {
    ...
    assertThat(measure.getMetricKey()).isEqualTo("hits");
    assertThat(measure.getPersistenceMode()).isEqualTo(PersistenceMode.DATABASE);
    assertThat(measure.getData()).isEqualTo("1=2;3=4");
  }
  ...
  public void shouldLoadIntValues() {
    ...
    assertThat(fileLineMeasures.getIntValue("hits", 1)).isEqualTo(2);
    assertThat(fileLineMeasures.getIntValue("hits", 3)).isEqualTo(4);
    assertThat(fileLineMeasures.getIntValue("hits", 5)).as("check no measure on line").isNull();
  }
  ...
  public void shouldLoadStringValues() {
    ...
    assertThat(fileLineMeasures.getStringValue("author", 1)).isEqualTo("simon");
    assertThat(fileLineMeasures.getStringValue("author", 3)).isEqualTo("evgeny");
    assertThat(fileLineMeasures.getStringValue("author", 5)).as("check no measure on line").isNull();
  }
  ...
  public void shouldNotFailIfNoMeasureInIndex() {
    assertThat(fileLineMeasures.getIntValue("hits", 1)).isNull();
    assertThat(fileLineMeasures.getStringValue("author", 1)).isNull();
  }
