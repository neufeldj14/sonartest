...
public class JSONReportTest {
  ...
  public void should_write_json() throws Exception {
    ...
    JSONAssert.assertEquals(IOUtils.toString(this.getClass().getResource(this.getClass().getSimpleName() + "/report.json"), StandardCharsets.UTF_8), writer.toString(), false);
  }
  ...
  public void should_exclude_resolved_issues() throws Exception {
    ...
    JSONAssert.assertEquals(IOUtils.toString(this.getClass().getResource(this.getClass().getSimpleName() + "/report-without-resolved-issues.json"), StandardCharsets.UTF_8),
      writer.toString(), true);
  }

  @Test
  public void should_ignore_components_without_issue() throws Exception {
